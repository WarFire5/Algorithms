...
public static class DZ8
{
    ...
    {
        Console.WriteLine("\n========================= Домашняя работа 8 =========================");
        Console.WriteLine("\nКаждому номеру закона и судебного решения, написанному с ошибками, " +
            "сопоставить его правильный вариант из файлов «номера_законов» и «номера_судебных_решений».");
